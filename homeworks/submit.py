...
data['image_name'] = '' # THE NAME OF THE OUTPUT IMAGE YOU'RE GOING TO SUBMIT, LEAVE IT EMPTY IF YOU WONT SUBMIT ANY OUTPUT IMAGE
...
data['cc']  = '' # IF YOU WANT YOU CAN SUBMIT A COPY OF YOUR SUBMISSION TO YOUR PERSONAL EMAIL ADDRESS YOU CAN LEAVE IT EMPTY IF YOU DONT WANT TO CC TO YOURSELF
